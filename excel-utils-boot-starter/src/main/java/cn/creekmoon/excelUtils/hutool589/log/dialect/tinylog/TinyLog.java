...
public class TinyLog extends AbstractLog {
	...
	@Override
	public boolean isEnabled(cn.creekmoon.excelUtils.hutool589.log.level.Level level) {
	 ...
	 * @since 4.0.3
	 */
	private Level toTinyLevel(cn.creekmoon.excelUtils.hutool589.log.level.Level level) {
		Level tinyLevel;
		switch (level) {
			case TRACE:

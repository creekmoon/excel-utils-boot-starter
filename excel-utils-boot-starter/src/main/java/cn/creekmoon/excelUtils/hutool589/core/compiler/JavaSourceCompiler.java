package cn.creekmoon.excelUtils.hutool589.core.compiler;
...
import cn.creekmoon.excelUtils.hutool589.core.io.resource.FileResource;
import cn.creekmoon.excelUtils.hutool589.core.io.resource.Resource;
import cn.creekmoon.excelUtils.hutool589.core.io.resource.StringResource;
...
public class JavaSourceCompiler {
	...
	public ClassLoader compile() {
		...
		// 创建编译器
		final JavaClassFileManager javaFileManager = new JavaClassFileManager(ucl, cn.creekmoon.excelUtils.hutool589.core.compiler.CompilerUtil.getFileManager());
	...
	private List<File> getClassPath() {
		...
		for (File file : libraryFileList) {
			List<File> jarOrZipFile = FileUtil.loopFiles(file, (subFile) -> cn.creekmoon.excelUtils.hutool589.core.compiler.JavaFileObjectUtil.isJarOrZipFile(subFile.getName()));

package cn.creekmoon.excelUtils.hutool589.core.date.format;
...
public class FastDateParser extends AbstractDateBasic implements DateParser {
	 ...
	 * </p>
	 * <p>
	 * Use {@link cn.creekmoon.excelUtils.hutool589.core.date.format.FastDateFormat#getInstance(String, TimeZone, Locale)} or another variation of the factory methods of {@link FastDateFormat} to get a cached FastDateParser instance.
	 *

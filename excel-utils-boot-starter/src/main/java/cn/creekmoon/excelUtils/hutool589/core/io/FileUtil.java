package cn.creekmoon.excelUtils.hutool589.core.io;

import cn.creekmoon.excelUtils.hutool589.core.collection.CollUtil;
import cn.creekmoon.excelUtils.hutool589.core.io.file.FileReader;
import cn.creekmoon.excelUtils.hutool589.core.io.file.*;
import cn.creekmoon.excelUtils.hutool589.core.io.file.FileWriter;
import cn.creekmoon.excelUtils.hutool589.core.io.file.FileReader.ReaderHandler;
import cn.creekmoon.excelUtils.hutool589.core.io.resource.ResourceUtil;
import cn.creekmoon.excelUtils.hutool589.core.io.unit.DataSizeUtil;
import cn.creekmoon.excelUtils.hutool589.core.lang.Assert;
import cn.creekmoon.excelUtils.hutool589.core.thread.ThreadUtil;
...
public class FileUtil extends PathUtil {
	...
	public static List<String> listFileNames(String path) throws IORuntimeException {
		...
		try {
			...
			cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.close(jarFile);
		}
	}
	...
	public static boolean contentEquals(File file1, File file2) throws IORuntimeException {
		...
		try {
			...
			return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.contentEquals(input1, input2);

		} finally {
			cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.close(input1);
			cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.close(input2);
		}
	}
	...
	public static boolean contentEqualsIgnoreEOL(File file1, File file2, Charset charset) throws IORuntimeException {
		...
		try {
			...
			return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.contentEqualsIgnoreEOL(input1, input2);
		} finally {
			cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.close(input1);
			cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.close(input2);
		}
	...
	public static BufferedInputStream getInputStream(File file) throws IORuntimeException {
		return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.toBuffered(cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.toStream(file));
	}
	...
	public static BufferedReader getBOMReader(File file) {
		return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.getReader(getBOMInputStream(file));
	}
	...
	public static BufferedReader getReader(File file, String charsetName) throws IORuntimeException {
		return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.getReader(getInputStream(file), CharsetUtil.charset(charsetName));
	}
	...
	public static BufferedReader getReader(File file, Charset charset) throws IORuntimeException {
		return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.getReader(getInputStream(file), charset);
	}
	...
	public static String readString(URL url, Charset charset) throws IORuntimeException {
		...
		try {
			in = url.openStream();
			return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.read(in, charset);
		} catch (IOException e) {
			throw new IORuntimeException(e);
		} finally {
			cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.close(in);
		}
	}
	...
	public static <T extends Collection<String>> T readLines(URL url, Charset charset, T collection) throws IORuntimeException {
		...
		try {
			in = url.openStream();
			return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.readLines(in, charset, collection);
		} catch (IOException e) {
			throw new IORuntimeException(e);
		} finally {
			cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.close(in);
	...
	public static BufferedOutputStream getOutputStream(File file) throws IORuntimeException {
		...
		return cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.toBuffered(out);
	}

...
public class MultipartRequestInputStream extends BufferedInputStream {
	...
	protected cn.creekmoon.excelUtils.hutool589.core.net.multipart.UploadFileHeader lastHeader;

	public cn.creekmoon.excelUtils.hutool589.core.net.multipart.UploadFileHeader getLastHeader() {
		return lastHeader;
	}
	 ...
	 * @throws IOException 读取异常
	 */
	public cn.creekmoon.excelUtils.hutool589.core.net.multipart.UploadFileHeader readDataHeader(Charset encoding) throws IOException {

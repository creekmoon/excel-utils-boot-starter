...
public class DateBetween implements Serializable {
	 ...
	 * @return 时长差
	 */
	public long between(cn.creekmoon.excelUtils.hutool589.core.date.DateUnit unit) {
	...
	public long betweenMonth(boolean isReset) {
		final Calendar beginCal = cn.creekmoon.excelUtils.hutool589.core.date.DateUtil.calendar(begin);
		final Calendar endCal = cn.creekmoon.excelUtils.hutool589.core.date.DateUtil.calendar(end);
	 ...
	 * @since 5.7.17
	 */
	public String toString(cn.creekmoon.excelUtils.hutool589.core.date.DateUnit unit, BetweenFormatter.Level level) {

...
public final class Singleton {
	...
	public static <T> T get(Class<T> clazz, Object... params) {
		cn.creekmoon.excelUtils.hutool589.core.lang.Assert.notNull(clazz, "Class must be not null !");
	...
	public static <T> T get(String className, Object... params) {
		cn.creekmoon.excelUtils.hutool589.core.lang.Assert.notBlank(className, "Class name must be not blank !");

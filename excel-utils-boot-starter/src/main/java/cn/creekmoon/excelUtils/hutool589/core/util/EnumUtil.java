...
public class EnumUtil {
	...
	public static <E extends Enum<E>> E fromStringQuietly(Class<E> enumClass, String value) {
		if (null == enumClass || cn.creekmoon.excelUtils.hutool589.core.util.StrUtil.isBlank(value)) {
			return null;
		}
	...
	public static boolean equalsIgnoreCase(final Enum<?> e, String val) {
		return cn.creekmoon.excelUtils.hutool589.core.util.StrUtil.equalsIgnoreCase(toString(e), val);
	}

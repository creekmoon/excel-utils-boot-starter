package cn.creekmoon.excelUtils.hutool589.core.math;

import java.util.List;

/**
 * 数学相关方法工具类<br>
 * 此工具类与{@link cn.creekmoon.excelUtils.hutool589.core.util.NumberUtil}属于一类工具，NumberUtil偏向于简单数学计算的封装，MathUtil偏向复杂数学计算
 *
 * @author looly
 * @since 4.0.7
 */
public class MathUtil {
	...
	public static long yuanToCent(double yuan) {
		return new cn.creekmoon.excelUtils.hutool589.core.math.Money(yuan).getCent();
	}

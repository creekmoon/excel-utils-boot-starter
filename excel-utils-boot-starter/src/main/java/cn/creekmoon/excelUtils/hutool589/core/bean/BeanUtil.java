...
import cn.creekmoon.excelUtils.hutool589.core.bean.copier.BeanCopier;
import cn.creekmoon.excelUtils.hutool589.core.bean.copier.CopyOptions;
import cn.creekmoon.excelUtils.hutool589.core.bean.copier.ValueProvider;
...
import cn.creekmoon.excelUtils.hutool589.core.map.CaseInsensitiveMap;
...
public class BeanUtil {
	...
	/**
	 * 获取{@link cn.creekmoon.excelUtils.hutool589.core.bean.BeanDesc} Bean描述信息
	 *
	 * @param clazz Bean类
	 * @return {@link cn.creekmoon.excelUtils.hutool589.core.bean.BeanDesc}
	 * @since 3.1.2
	 */
	public static cn.creekmoon.excelUtils.hutool589.core.bean.BeanDesc getBeanDesc(Class<?> clazz) {
	 ...
	 * @see cn.creekmoon.excelUtils.hutool589.core.bean.BeanPath#get(Object)
	 * @since 3.0.7
	 */
	...
	public static <T> T getProperty(Object bean, String expression) {
		...
		return (T) cn.creekmoon.excelUtils.hutool589.core.bean.BeanPath.create(expression).get(bean);
	}

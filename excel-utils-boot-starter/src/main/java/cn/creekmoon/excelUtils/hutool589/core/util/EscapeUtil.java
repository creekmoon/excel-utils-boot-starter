...
import cn.creekmoon.excelUtils.hutool589.core.text.escape.Html4Escape;
import cn.creekmoon.excelUtils.hutool589.core.text.escape.Html4Unescape;
import cn.creekmoon.excelUtils.hutool589.core.text.escape.XmlEscape;
import cn.creekmoon.excelUtils.hutool589.core.text.escape.XmlUnescape;
...
public class EscapeUtil {
	...
	private static final Filter<Character> JS_ESCAPE_FILTER = c -> false == (
			Character.isDigit(c)
					...
					|| cn.creekmoon.excelUtils.hutool589.core.util.StrUtil.contains(NOT_ESCAPE_CHARS, c)
	);
	...
	public static String escape(CharSequence content, Filter<Character> filter) {
		if (cn.creekmoon.excelUtils.hutool589.core.util.StrUtil.isEmpty(content)) {
			return cn.creekmoon.excelUtils.hutool589.core.util.StrUtil.str(content);
		}

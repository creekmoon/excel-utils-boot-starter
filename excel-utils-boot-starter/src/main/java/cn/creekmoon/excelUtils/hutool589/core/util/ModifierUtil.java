...
public class ModifierUtil {
	...
	public static boolean hasModifier(Class<?> clazz, ModifierType... modifierTypes) {
		if (null == clazz || cn.creekmoon.excelUtils.hutool589.core.util.ArrayUtil.isEmpty(modifierTypes)) {
			return false;
		}
	...
	public static boolean hasModifier(Constructor<?> constructor, ModifierType... modifierTypes) {
		if (null == constructor || cn.creekmoon.excelUtils.hutool589.core.util.ArrayUtil.isEmpty(modifierTypes)) {
			return false;
		}
	...
	public static boolean hasModifier(Method method, ModifierType... modifierTypes) {
		if (null == method || cn.creekmoon.excelUtils.hutool589.core.util.ArrayUtil.isEmpty(modifierTypes)) {
			return false;
		}

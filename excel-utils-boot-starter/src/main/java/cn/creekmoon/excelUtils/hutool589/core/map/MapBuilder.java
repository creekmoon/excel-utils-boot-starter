...
public class MapBuilder<K, V> implements Builder<Map<K, V>> {
	...
	public static <K, V> MapBuilder<K, V> create(boolean isLinked) {
		return create(cn.creekmoon.excelUtils.hutool589.core.map.MapUtil.newHashMap(isLinked));
	}
	...
	public String join(String separator, final String keyValueSeparator) {
		return cn.creekmoon.excelUtils.hutool589.core.map.MapUtil.join(this.map, separator, keyValueSeparator);
	}
	...
	public String joinIgnoreNull(String separator, final String keyValueSeparator) {
		return cn.creekmoon.excelUtils.hutool589.core.map.MapUtil.joinIgnoreNull(this.map, separator, keyValueSeparator);
	}

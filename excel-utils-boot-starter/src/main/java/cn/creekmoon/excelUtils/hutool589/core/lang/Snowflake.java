...
import cn.creekmoon.excelUtils.hutool589.core.date.SystemClock;
import cn.creekmoon.excelUtils.hutool589.core.util.IdUtil;
import cn.creekmoon.excelUtils.hutool589.core.util.RandomUtil;
...
public class Snowflake implements Serializable {
	...
	public Snowflake(Date epochDate, long workerId, long dataCenterId,
		...
		this.workerId = cn.creekmoon.excelUtils.hutool589.core.lang.Assert.checkBetween(workerId, 0, MAX_WORKER_ID);
		this.dataCenterId = cn.creekmoon.excelUtils.hutool589.core.lang.Assert.checkBetween(dataCenterId, 0, MAX_DATA_CENTER_ID);

package cn.creekmoon.excelUtils.hutool589.core.lang.func;
...
import cn.creekmoon.excelUtils.hutool589.core.util.ReflectUtil;
...
public class LambdaUtil {
	 ...
	 * @since 5.8.0
	 */
	public static <R> Class<R> getRealClass(cn.creekmoon.excelUtils.hutool589.core.lang.func.Func0<?> func) {
	 ...
	 * @return 返回解析后的结果
	 */
	public static <T> SerializedLambda resolve(cn.creekmoon.excelUtils.hutool589.core.lang.func.Func1<T, ?> func) {
	 ...
	 * @since 5.7.23
	 */
	public static <R> SerializedLambda resolve(cn.creekmoon.excelUtils.hutool589.core.lang.func.Func0<R> func) {
		return _resolve(func);
	}
	 ...
	 * @return 函数名称
	 */
	public static <P> String getMethodName(cn.creekmoon.excelUtils.hutool589.core.lang.func.Func1<P, ?> func) {
	 ...
	 * @since 5.7.23
	 */
	public static <R> String getMethodName(cn.creekmoon.excelUtils.hutool589.core.lang.func.Func0<R> func) {
		return resolve(func).getImplMethodName();
	}
	 ...
	 * @since 5.8.0
	 */
	public static <P, R> Class<P> getRealClass(cn.creekmoon.excelUtils.hutool589.core.lang.func.Func1<P, R> func) {
		final SerializedLambda lambda = resolve(func);
		checkLambdaTypeCanGetClass(lambda.getImplMethodKind());

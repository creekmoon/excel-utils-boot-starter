...
import cn.creekmoon.excelUtils.hutool589.core.collection.ComputeIter;
 ...
 * @author Looly
 */
public final class CsvParser extends ComputeIter<cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvRow> implements Closeable, Serializable {
	 ...
	 * 标题行
	 */
	private cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvRow header;
	/**
	 * 当前行号
	 */
	...
	@Override
	protected cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvRow computeNext() {
		return nextRow();
	}
	 ...
	 */
	public cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvRow nextRow() throws IORuntimeException {
		...
		while (false == finished) {
			...
			return new cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvRow(lineNo, null == header ? null : header.headerMap, currentFields);
		}

package cn.creekmoon.excelUtils.hutool589.core.thread;
...
public class ExecutorBuilder implements Builder<ThreadPoolExecutor> {
	 ...
	 * <p>
	 * 此处可以使用JDK预定义的几种策略，见{@link cn.creekmoon.excelUtils.hutool589.core.thread.RejectPolicy}枚举
	 *
	 * @param handler {@link RejectedExecutionHandler}
	 * @return this
	 * @see cn.creekmoon.excelUtils.hutool589.core.thread.RejectPolicy
	 */

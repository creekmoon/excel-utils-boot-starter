...
import cn.creekmoon.excelUtils.hutool589.core.util.PageUtil;
...
public class ListUtil {
	...
	public static <T> List<T> page(int pageNo, int pageSize, List<T> list) {
		if (cn.creekmoon.excelUtils.hutool589.core.collection.CollUtil.isEmpty(list)) {
	...
	public static <T> void page(List<T> list, int pageSize, Consumer<List<T>> pageListConsumer) {
		if (cn.creekmoon.excelUtils.hutool589.core.collection.CollUtil.isEmpty(list) || pageSize <= 0) {
			return;
		}
	...
	public static <T> int[] indexOfAll(List<T> list, Matcher<T> matcher) {
		return cn.creekmoon.excelUtils.hutool589.core.collection.CollUtil.indexOfAll(list, matcher);
	}
	...
	public static <T> void swapTo(List<T> list, T element, Integer targetIndex) {
		if (cn.creekmoon.excelUtils.hutool589.core.collection.CollUtil.isNotEmpty(list)) {

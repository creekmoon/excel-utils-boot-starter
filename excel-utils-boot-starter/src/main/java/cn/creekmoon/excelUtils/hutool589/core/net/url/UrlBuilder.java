...
public final class UrlBuilder implements Builder<String> {
	 ...
	 * 路径，例如/aa/bb/cc
	 */
	private cn.creekmoon.excelUtils.hutool589.core.net.url.UrlPath path;
	/**
	 * 查询语句，例如a=1&amp;b=2
	 */
	private cn.creekmoon.excelUtils.hutool589.core.net.url.UrlQuery query;
	/**
	 * 标识符，例如#后边的部分
	 */
	...
	public static UrlBuilder of(String scheme, String host, int port, String path, String query, String fragment, Charset charset) {
		return of(scheme, host, port,
				cn.creekmoon.excelUtils.hutool589.core.net.url.UrlPath.of(path, charset),
				cn.creekmoon.excelUtils.hutool589.core.net.url.UrlQuery.of(query, charset, false), fragment, charset);
	}
	 ...
	 * @return UrlBuilder
	 */
	public static UrlBuilder of(String scheme, String host, int port, cn.creekmoon.excelUtils.hutool589.core.net.url.UrlPath path, cn.creekmoon.excelUtils.hutool589.core.net.url.UrlQuery query, String fragment, Charset charset) {
	 ...
	 */
	public UrlBuilder(String scheme, String host, int port, cn.creekmoon.excelUtils.hutool589.core.net.url.UrlPath path, cn.creekmoon.excelUtils.hutool589.core.net.url.UrlQuery query, String fragment, Charset charset) {
	 ...
	 */
	public cn.creekmoon.excelUtils.hutool589.core.net.url.UrlPath getPath() {
		return path;
	}
	...
	public UrlBuilder setWithEndTag(boolean withEngTag) {
		if (null == this.path) {
			this.path = new cn.creekmoon.excelUtils.hutool589.core.net.url.UrlPath();
		}
	 ...
	 * @return this
	 */
	public UrlBuilder setPath(cn.creekmoon.excelUtils.hutool589.core.net.url.UrlPath path) {
		this.path = path;
		return this;
	}
	...
	public UrlBuilder addPath(CharSequence path) {
		cn.creekmoon.excelUtils.hutool589.core.net.url.UrlPath.of(path, this.charset).getSegments().forEach(this::addPathSegment);
		return this;
	}
	 ...
	 */
	public cn.creekmoon.excelUtils.hutool589.core.net.url.UrlQuery getQuery() {
		return query;
	}
	 ...
	 * @return this
	 */
	public UrlBuilder setQuery(cn.creekmoon.excelUtils.hutool589.core.net.url.UrlQuery query) {
		this.query = query;
		return this;
	}

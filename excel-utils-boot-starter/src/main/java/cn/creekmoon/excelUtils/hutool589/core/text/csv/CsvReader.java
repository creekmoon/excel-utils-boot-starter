 ...
 * @since 4.0.1
 */
public class CsvReader extends CsvBaseReader implements Iterable<cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvRow>, Closeable {
	 ...
	 * @since 5.7.14
	 */
	public Stream<cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvRow> stream() {

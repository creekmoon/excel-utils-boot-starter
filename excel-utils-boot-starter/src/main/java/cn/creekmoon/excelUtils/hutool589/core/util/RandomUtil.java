...
import cn.creekmoon.excelUtils.hutool589.core.date.DateField;
...
import cn.creekmoon.excelUtils.hutool589.core.lang.WeightRandom;
import cn.creekmoon.excelUtils.hutool589.core.lang.WeightRandom.WeightObj;
...
public class RandomUtil {
	...
	public static double randomDouble(double min, double max, int scale, RoundingMode roundingMode) {
		return cn.creekmoon.excelUtils.hutool589.core.util.NumberUtil.round(randomDouble(min, max), scale, roundingMode).doubleValue();
	}
	...
	public static double randomDouble(int scale, RoundingMode roundingMode) {
		return cn.creekmoon.excelUtils.hutool589.core.util.NumberUtil.round(randomDouble(), scale, roundingMode).doubleValue();
	}
	...
	public static double randomDouble(double limit, int scale, RoundingMode roundingMode) {
		return cn.creekmoon.excelUtils.hutool589.core.util.NumberUtil.round(randomDouble(limit), scale, roundingMode).doubleValue();
	}
	...
	public static BigDecimal randomBigDecimal() {
		return cn.creekmoon.excelUtils.hutool589.core.util.NumberUtil.toBigDecimal(getRandom().nextDouble());
	}
	...
	public static BigDecimal randomBigDecimal(BigDecimal limit) {
		return cn.creekmoon.excelUtils.hutool589.core.util.NumberUtil.toBigDecimal(getRandom().nextDouble(limit.doubleValue()));
	}
	...
	public static <T> List<T> randomEleList(List<T> source, int count) {
		...
		final int[] randomList = cn.creekmoon.excelUtils.hutool589.core.util.ArrayUtil.sub(randomInts(source.size()), 0, count);
	...
	public static int[] randomInts(int length) {
		final int[] range = cn.creekmoon.excelUtils.hutool589.core.util.ArrayUtil.range(length);
	...
	public static String randomStringWithoutStr(int length, String elemData) {
		...
		baseStr = cn.creekmoon.excelUtils.hutool589.core.util.StrUtil.removeAll(baseStr, elemData.toLowerCase().toCharArray());
	...
	public static String randomString(String baseString, int length) {
		if (cn.creekmoon.excelUtils.hutool589.core.util.StrUtil.isEmpty(baseString)) {

...
public class FileTypeUtil {
	...
	public static String getType(InputStream in) throws IORuntimeException {
		return getType(cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.readHex28Upper(in));
	}
	...
	public static String getType(InputStream in, String filename) {
		...
		if (null == typeName) {
			// 未成功识别类型，扩展名辅助识别
			typeName = cn.creekmoon.excelUtils.hutool589.core.io.FileUtil.extName(filename);
		} else if ("xls".equals(typeName)) {
			// xls、doc、msi的头一样，使用扩展名辅助判断
			final String extName = cn.creekmoon.excelUtils.hutool589.core.io.FileUtil.extName(filename);
	...
	public static String getType(File file) throws IORuntimeException {
		...
		try {
			in = cn.creekmoon.excelUtils.hutool589.core.io.IoUtil.toStream(file);

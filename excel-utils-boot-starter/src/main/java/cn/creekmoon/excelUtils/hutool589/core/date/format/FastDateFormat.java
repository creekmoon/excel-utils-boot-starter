...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
	...
	private static final cn.creekmoon.excelUtils.hutool589.core.date.format.FormatCache<FastDateFormat> CACHE = new cn.creekmoon.excelUtils.hutool589.core.date.format.FormatCache<FastDateFormat>() {
		@Override

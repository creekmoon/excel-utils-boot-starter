package cn.creekmoon.excelUtils.hutool589.core.img.gif;
...
public class AnimatedGifEncoder {
	...
	protected void analyzePixels() {
		...
		cn.creekmoon.excelUtils.hutool589.core.img.gif.NeuQuant nq = new NeuQuant(pixels, len, sample);
	...
	protected void writePixels() throws IOException {
		cn.creekmoon.excelUtils.hutool589.core.img.gif.LZWEncoder encoder = new cn.creekmoon.excelUtils.hutool589.core.img.gif.LZWEncoder(width, height, indexedPixels, colorDepth);
		encoder.encode(out);
	}

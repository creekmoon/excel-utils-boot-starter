package cn.creekmoon.excelUtils.hutool589.core.text;

import cn.creekmoon.excelUtils.hutool589.core.collection.CollUtil;
import cn.creekmoon.excelUtils.hutool589.core.comparator.VersionComparator;
...
import cn.creekmoon.excelUtils.hutool589.core.lang.Matcher;
import cn.creekmoon.excelUtils.hutool589.core.lang.func.Func1;
import cn.creekmoon.excelUtils.hutool589.core.text.finder.CharFinder;
import cn.creekmoon.excelUtils.hutool589.core.text.finder.Finder;
import cn.creekmoon.excelUtils.hutool589.core.text.finder.StrFinder;
...
public class CharSequenceUtil {
	...
	public static String[] splitToArray(CharSequence str, CharSequence separator) {
		...
		return cn.creekmoon.excelUtils.hutool589.core.text.StrSplitter.splitToArray(str.toString(), str(separator), 0, false, false);
	}
	...
	public static String[] splitToArray(CharSequence text, char separator, int limit) {
		...
		return cn.creekmoon.excelUtils.hutool589.core.text.StrSplitter.splitToArray(text.toString(), separator, limit, false, false);
	}
	...
	public static List<String> split(CharSequence str, char separator, int limit, boolean isTrim, boolean ignoreEmpty) {
		return cn.creekmoon.excelUtils.hutool589.core.text.StrSplitter.split(str, separator, limit, isTrim, ignoreEmpty);
	}
	...
	public static <R> List<R> split(CharSequence str, char separator, int limit, boolean ignoreEmpty, Function<String, R> mapping) {
		return cn.creekmoon.excelUtils.hutool589.core.text.StrSplitter.split(str, separator, limit, ignoreEmpty, mapping);
	}
	...
	public static List<String> split(CharSequence str, CharSequence separator, int limit, boolean isTrim, boolean ignoreEmpty) {
		...
		return cn.creekmoon.excelUtils.hutool589.core.text.StrSplitter.split(str, separatorStr, limit, isTrim, ignoreEmpty);
	}
	 ...
	 * @param len 每一个小节的长度
	 * @return 截取后的字符串数组
	 * @see cn.creekmoon.excelUtils.hutool589.core.text.StrSplitter#splitByLength(CharSequence, int)
	 */
	 ...
	 * @see cn.creekmoon.excelUtils.hutool589.core.text.NamingCase#toUnderlineCase(CharSequence)
	 */
	public static String toUnderlineCase(CharSequence str) {
		return cn.creekmoon.excelUtils.hutool589.core.text.NamingCase.toUnderlineCase(str);
	}
	 ...
	 * @see cn.creekmoon.excelUtils.hutool589.core.text.NamingCase#toSymbolCase(CharSequence, char)
	 * @since 4.0.10
	 */
	public static String toSymbolCase(CharSequence str, char symbol) {
		return cn.creekmoon.excelUtils.hutool589.core.text.NamingCase.toSymbolCase(str, symbol);
	}
	 ...
	 * @see cn.creekmoon.excelUtils.hutool589.core.text.NamingCase#toCamelCase(CharSequence)
	 */
	public static String toCamelCase(CharSequence name) {
		return cn.creekmoon.excelUtils.hutool589.core.text.NamingCase.toCamelCase(name);
	}
	 ...
	 * @param symbol 连接符
	 * @return 转换后的驼峰式命名的字符串
	 * @see cn.creekmoon.excelUtils.hutool589.core.text.NamingCase#toCamelCase(CharSequence, char)
	 */
	 ...
	 * @return StrBuilder对象
	 */
	public static cn.creekmoon.excelUtils.hutool589.core.text.StrBuilder strBuilder(CharSequence... strs) {
		return cn.creekmoon.excelUtils.hutool589.core.text.StrBuilder.create(strs);
	}
	...
	public static String concat(boolean isNullToEmpty, CharSequence... strs) {
		final cn.creekmoon.excelUtils.hutool589.core.text.StrBuilder sb = new StrBuilder();
		for (CharSequence str : strs) {
	 ...
	 *
	 * @param conjunction 分隔符 {@link cn.creekmoon.excelUtils.hutool589.core.text.StrPool#COMMA}
	 * @param objs        数组
	 * @return 连接后的字符串

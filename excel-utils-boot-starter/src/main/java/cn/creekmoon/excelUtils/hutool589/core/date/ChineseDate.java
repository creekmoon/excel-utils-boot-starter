...
import cn.creekmoon.excelUtils.hutool589.core.date.chinese.*;
...
public class ChineseDate {
	...
	public ChineseDate(int chineseYear, int chineseMonth, int chineseDay, boolean isLeapMonth) {
		...
		final cn.creekmoon.excelUtils.hutool589.core.date.DateTime dateTime = lunar2solar(chineseYear, chineseMonth, chineseDay, isLeapMonth);
		if (null != dateTime) {
			//初始化公历年
	...
	public Date getGregorianDate() {
		return cn.creekmoon.excelUtils.hutool589.core.date.DateUtil.date(getGregorianCalendar());
	}

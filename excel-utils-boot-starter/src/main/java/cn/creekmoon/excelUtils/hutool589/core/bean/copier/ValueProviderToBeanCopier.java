package cn.creekmoon.excelUtils.hutool589.core.bean.copier;

import cn.creekmoon.excelUtils.hutool589.core.bean.BeanUtil;
import cn.creekmoon.excelUtils.hutool589.core.bean.PropDesc;
...
/**
 * {@link cn.creekmoon.excelUtils.hutool589.core.bean.copier.ValueProvider}属性拷贝到Bean中的拷贝器
 *
 * @param <T> 目标Bean类型
 * @since 5.8.0
 */
public class ValueProviderToBeanCopier<T> extends AbsCopier<cn.creekmoon.excelUtils.hutool589.core.bean.copier.ValueProvider<String>, T> {

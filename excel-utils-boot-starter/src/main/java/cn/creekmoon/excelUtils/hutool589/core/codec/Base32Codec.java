 ...
 * @since 5.8.0
 */
public class Base32Codec implements cn.creekmoon.excelUtils.hutool589.core.codec.Encoder<byte[], String>, cn.creekmoon.excelUtils.hutool589.core.codec.Decoder<CharSequence, byte[]> {

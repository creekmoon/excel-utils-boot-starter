package cn.creekmoon.excelUtils.hutool589.core.map.multi;

import cn.creekmoon.excelUtils.hutool589.core.collection.IterUtil;
import cn.creekmoon.excelUtils.hutool589.core.collection.TransIter;
...
/**
 * 抽象{@link cn.creekmoon.excelUtils.hutool589.core.map.multi.Table}接口实现<br>
 * 默认实现了：
 * <ul>
 ...
 * @since 5.7.23
 */
public abstract class AbsTable<R, C, V> implements cn.creekmoon.excelUtils.hutool589.core.map.multi.Table<R, C, V> {

	@Override
	public boolean equals(Object obj) {
		if (obj == this) {
			return true;
		} else if (obj instanceof cn.creekmoon.excelUtils.hutool589.core.map.multi.Table) {
			final cn.creekmoon.excelUtils.hutool589.core.map.multi.Table<?, ?, ?> that = (cn.creekmoon.excelUtils.hutool589.core.map.multi.Table<?, ?, ?>) obj;

...
import cn.creekmoon.excelUtils.hutool589.core.exceptions.ValidateException;
...
public class Validator {
	...
	public static boolean isBetween(Number value, Number min, Number max) {
		cn.creekmoon.excelUtils.hutool589.core.lang.Assert.notNull(value);
		cn.creekmoon.excelUtils.hutool589.core.lang.Assert.notNull(min);
		Assert.notNull(max);

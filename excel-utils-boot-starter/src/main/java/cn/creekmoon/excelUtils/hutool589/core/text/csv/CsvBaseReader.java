package cn.creekmoon.excelUtils.hutool589.core.text.csv;
...
public class CsvBaseReader implements Serializable {
	 ...
	 *
	 * @param file CSV文件
	 * @return {@link cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData}，包含数据列表和行信息
	 * @throws IORuntimeException IO异常
	 */
	public cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData read(File file) throws IORuntimeException {
	 ...
	 * @return {@link cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData}，包含数据列表和行信息
	 */
	public cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData readFromStr(String csvStr) {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData read(File file, Charset charset) throws IORuntimeException {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData read(Path path) throws IORuntimeException {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData read(Path path, Charset charset) throws IORuntimeException {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData read(Reader reader) throws IORuntimeException {
		final cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvParser csvParser = parse(reader);
		...
		return new cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvData(header, rows);
	}
	 ...
	 * @since 5.0.4
	 */
	private void read(cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvParser csvParser, CsvRowHandler rowHandler) throws IORuntimeException {
		try {
	...
	/**
	 * 构建 {@link cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvParser}
	 *
	 * @param reader Reader
	 * @return CsvParser
	 * @throws IORuntimeException IO异常
	 */
	protected cn.creekmoon.excelUtils.hutool589.core.text.csv.CsvParser parse(Reader reader) throws IORuntimeException {

 ...
 * @since 5.7.22
 */
public class Base58Codec implements cn.creekmoon.excelUtils.hutool589.core.codec.Encoder<byte[], String>, cn.creekmoon.excelUtils.hutool589.core.codec.Decoder<CharSequence, byte[]> {

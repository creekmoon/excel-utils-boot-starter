...
@Slf4j
public class CellSheetReader<R> {

    public SheetReaderContext sheetReaderContext;

    protected ExcelImport parent;

    public <T> CellSheetReader<R> addConvert(String cellReference, ExFunction<String, T> convert, BiConsumer<R, T> setter) {
    ...
    public CellSheetReader<R> addConvert(String cellReference, BiConsumer<R, String> reader) {
    ...
    private <T> CellSheetReader<R> addConvert(int rowIndex, int colIndex, ExFunction<String, T> convert, BiConsumer<R, T> setter) {
    ...
    public <T> CellSheetReader<R> addConvertAndSkipEmpty(int rowIndex, int colIndex, BiConsumer<R, String> setter) {
        return addConvertAndSkipEmpty(rowIndex, colIndex, x -> x, setter);
    }

    public <T> CellSheetReader<R> addConvertAndSkipEmpty(int rowIndex, int colIndex, ExFunction<String, T> convert, BiConsumer<R, T> setter) {
    ...
    public <T> CellSheetReader<R> addConvertAndSkipEmpty(String cellReference, ExFunction<String, T> convert, BiConsumer<R, T> setter) {
    ...
    public <T> CellSheetReader<R> addConvertAndMustExist(int rowIndex, int colIndex, ExFunction<String, T> convert, BiConsumer<R, T> setter) {
    ...
    public <T> CellSheetReader<R> addConvertAndMustExist(String title, ExFunction<String, T> convert, BiConsumer<R, T> setter) {
    ...
    public CellSheetReader<R> addConvertAndMustExist(int rowIndex, int colIndex, BiConsumer<R, String> setter) {
        return addConvertAndMustExist(rowIndex, colIndex, x -> x, setter);
    }

    public CellSheetReader<R> addConvertAndMustExist(String cellReference, BiConsumer<R, String> setter) {
     ...
     * @return
     */
    public <T> CellSheetReader<R> addConvertPostProcessor(ExConsumer<R> postProcessor) {
    ...
    public void read(ExConsumer<R> consumer) throws CheckedExcelException {
        try {
            //新版读取 使用SAX读取模式
